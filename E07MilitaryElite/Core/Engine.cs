        ...
        public void Run()
        {
            ...
            while (input != "End")
            {
                ...
                else if (type == "LieutenantGeneral")
                {
                    ...
                    {
                        ISoldier currPrivate =
                            this._soldiers.FirstOrDefault(x => x.Id == privateId);

                        lieutenant.AddPrivate(currPrivate);
                    }
                ...
                else if (type == "Engineer")
                {
                    try
                    {
                        ...
                        for (int i = 0; i < repairs.Length; i+= 2)
                        {
                            ...
                            int hoursForRepair =int.Parse(repairs[i + 1]);
                            IRepair repair = new Repair(repPart, hoursForRepair);
